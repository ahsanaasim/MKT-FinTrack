      ...
      <main className="flex flex-1 items-center justify-center px-4 py-16 sm:px-6">
        <section className="w-full max-w-2xl rounded-2xl border border-border bg-card p-8 text-center shadow-sm sm:p-12">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted-foreground">
            This financial story is private. Re-authenticate or return to your
            dashboard to continue with pages you can access.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Button asChild>
              <Link href="/auth/login">Re-authenticate</Link>
            </Button>
